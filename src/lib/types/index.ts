...
export {
  ...
  type ProductStatus,
  type ModelStatus,
  type WineTerrestrialData,
  type TerrestrialModel,
  type AgingProduct,
  type AgingPrediction,
  type FlavorDictionary,
  type UAPSConfig,
  type ProductInput,
  type PredictionInput,
  type FlavorRadarData,
  type TimelineDataPoint,
  type ParsedUAPSConfig,
  type TerrestrialDataFilters,
  WINE_TYPE_LABELS,
  AGING_STAGE_LABELS,
  DATA_SOURCE_LABELS,
