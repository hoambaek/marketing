...
import { formatDateKorean, formatDDay, getDDayColorClass, getWeekDateRange, getWeekOfMonth } from '@/lib/utils/date';
...
export default function TaskModal({ isOpen, onClose, onSave, task, month, week }: TaskModalProps) {
  ...
  // 동적 타이틀 계산
  const modalTitle = task ? (isEditing ? '업무 수정' : '업무 상세') : '새 업무 추가';
