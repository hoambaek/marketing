      ...
      <AnimatePresence>
        {isOpen && (
          <motion.div
            ...
            className="fixed bottom-24 right-6 z-50 w-[400px] h-[600px] max-h-[80vh]
          ...
          >
            ...
            <div className="px-5 py-4 border-b border-amber-900/20
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  <h3 className="text-amber-100 font-medium tracking-wide" style={{ fontFamily: 'var(--font-cormorant)' }}>
                    Muse AI Assistant
                  </h3>
                  <p className="text-xs text-amber-700/80">마케팅 플랜 & 이슈 관리</p>
                </div>
              </div>
            </div>

            {/* 메시지 영역 */}
            <div className="flex-1 overflow-y-auto p-4 space-y-4 scrollbar-thin scrollbar-thumb-amber-900/30">
              {messages.length === 0 && (
                <div className="h-full flex flex-col items-center justify-center text-center px-6">
                  ...
                  <h4 className="text-amber-200/80 font-medium mb-2" style={{ fontFamily: 'var(--font-cormorant)' }}>
                    무엇을 도와드릴까요?
                  </h4>
                  ...
                  <div className="mt-6 space-y-2 w-full">
                    {[
                      ...
                      <button
                        ...
                        className="w-full px-4 py-2 text-left text-sm text-amber-300/70
            ...
            <div className="p-4 border-t border-amber-900/20 bg-stone-900/50">
              <div className="flex gap-2">
                ...
                <button
                  ...
                  className="px-4 py-3 bg-gradient-to-br from-amber-600 to-amber-700
